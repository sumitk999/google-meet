...
// await newPage.close()
await newP.goto(url)
await newP.waitForTimeout(4000)

const aa = await newP.waitForSelector('button[data-tid=joinOnWeb]');
await newP.click('button[data-tid=joinOnWeb]')
await newP.waitForTimeout(90000)
console.log("before button");
await newP.mouse.click(1140, 550, {delay: 3000, button: 'left'});
console.log("button clicked");
// const cc= await newP.waitForSelector('button[data-tid="prejoin-join-button"]');
// console.log("cc value is",cc);

// prejoin-join-button
// console.log("after button selector");
// await newP.focus('button[data-tid=prejoin-join-button]')
// console.log("after focus button ");
// await newP.click('button[data-tid=prejoin-join-button]')
